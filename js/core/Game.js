...
class Game {
    ...
    startTowerMergeAnimation(targetTower, consumedTower) {
        ...
        const startCenter = typeof consumedTower.center === 'function' ? consumedTower.center() : null;
        const endCenter = typeof targetTower.center === 'function' ? targetTower.center() : null;
