const DEFAULT_LOGICAL_W = 540;
const DEFAULT_LOGICAL_H = 960;
...
export function createViewport(displaySize, options = {}) {
    ...
    const logicalWidth = resolveDimension(options.logicalWidth, DEFAULT_LOGICAL_W);
    const logicalHeight = resolveDimension(options.logicalHeight, DEFAULT_LOGICAL_H);
...
export function resizeCanvas({ canvasElement, gameContainerElement, gameInstance, metrics }) {
    ...
    const logicalWidth = resolveDimension(gameInstance?.logicalW, DEFAULT_LOGICAL_W);
    const logicalHeight = resolveDimension(gameInstance?.logicalH, DEFAULT_LOGICAL_H);
