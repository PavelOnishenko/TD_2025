...
export default class GameRuntimeUiBinder {
    ...
    private readonly createHandlers = () => ({
        ...
        onOpenFerryFromWorld: () => this.game.tryEnterVillageFromWorldMap(),
        onConfirmFerryTravel: () => this.game.confirmWorldFerryTravel(),
        onDismissFerryPrompt: () => this.game.dismissWorldFerryPrompt(),
        onSelectFerryDestination: (routeIndex) => this.game.selectWorldFerryRoute(routeIndex),
