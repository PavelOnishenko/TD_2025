...
export const PLAYER_COMBAT_ACTIONS: CombatUiActionDefinition[] = [
    { id: 'fast-left', label: 'Fast Left', type: 'fast', direction: 'left' },
    { id: 'fast-center', label: 'Fast Center', type: 'fast', direction: 'center' },
    { id: 'fast-right', label: 'Fast Right', type: 'fast', direction: 'right' },
