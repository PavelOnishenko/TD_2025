...
import { DeliverObjectiveData, GeneratedName, QuestNode, QuestObjectiveType, QuestTextEntity, RareMonsterProfile } from './QuestTypes.js';
...
export default class QuestLeafFactory {
    ...
    private node(
        ...
        objectiveData?: { deliver?: DeliverObjectiveData },
    ): QuestNode {
