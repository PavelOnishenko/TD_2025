...
const PROFILE_TEMPLATES: Record<string, ProfileTemplate> = {
    player: createTemplate('center', [1, 1.1, 1], [5, 2, 3, 2, 2.5, 0], [0.6, 0.4, 0.6]),
    human: createTemplate('center', [1, 0.8, 0.9], [4, 1.8, 2, 2.4, 2.8, 1.8], [0.9, 1.2, 0.9]),
    skeleton: createTemplate('center', [1.2, 0.7, 1.1], [3.6, 1.4, 1.5, 2.6, 1.4, 0], [0.8, 1.5, 0.8]),
    zombie: createTemplate('center', [0.8, 1.4, 0.5], [3.2, 0.8, 2.6, 0.8, 0.8, 0], [0.8, 1.4, 0.8]),
    ninja: createTemplate('left', [1.1, 0.7, 1.2], [3.2, 2.8, 1.2, 1.3, 3.2, 0], [1.2, 0.7, 1.1]),
    darkKnight: createTemplate('center', [1, 1.2, 1], [3.8, 1.1, 2.5, 3.1, 0.7, 0], [0.9, 1.3, 0.9]),
    dragon: createTemplate('center', [1, 1.1, 1], [4.2, 0.7, 2.8, 1.6, 0.6, 0], [0.9, 1.2, 0.9]),
};
...
export default class CombatBehaviorFactory {
    ...
    private createProfile(archetypeId: string): CombatBehaviorProfile {
        ...
        return {
            ...
            fastAttackWeight: this.rollWeight(template.fastAttackWeight),
...
function createTemplate(
    ...
    return {
        ...
        fastAttackWeight: weights[1],
        heavyAttackWeight: weights[2],
        counterWeight: weights[3],
        dodgeWeight: weights[4],
        rangedWeight: weights[5],
