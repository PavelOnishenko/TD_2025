...
export default class StickFigure {
    ...
    public static draw(
        ...
        ctx.fillStyle = color;
        const limbLineWidth = this.LIMB_LINE_WIDTH * scale;
        const coreBoneLineWidth = this.CORE_BONE_LINE_WIDTH * scale;
        const outlineWidth = this.OUTLINE_WIDTH * scale;
        const hasOutline = outlineWidth > 0;
        const outlineColor = theme.ui.primaryBg;
