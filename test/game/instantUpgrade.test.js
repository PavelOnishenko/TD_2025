...
import featureFlags from '../../js/config/featureFlags.js';
import { updateHUD } from '../../js/systems/ui.js';
...
test('upgrade button stays hidden when feature is disabled', () => {
    const originalFlag = featureFlags.instantTowerUpgrade.enabled;
    featureFlags.instantTowerUpgrade.enabled = false;
    ...
    try {
        ...
        assert.equal(game.upgradeBtn.hidden, true);
    } finally {
        featureFlags.instantTowerUpgrade.enabled = originalFlag;
    }
});
