...
test('loadAssets returns sounds only when audio is supported', async () => {
    ...
    assert.deepEqual(createdImages, [
        ...
        'assets/images/asteroids/asteroid-01-large-crater.png',
        'assets/images/asteroids/asteroid-02-wide-crater.png',
        'assets/images/asteroids/asteroid-03-left-cluster.png',
        'assets/images/asteroids/asteroid-04-right-cluster.png',
        'assets/images/asteroids/asteroid-05-massive-crater.png',
        'assets/images/asteroids/asteroid-06-small-crater.png',
        'assets/images/asteroids/asteroid-07-pebble.png',
        'assets/images/asteroids/asteroid-10-small-pebble.png',
        'assets/images/asteroids/asteroid-12-tall-shard.png',
